...
move_uploaded_file($_FILES["productimage"]["tmp_name"],"hotelsimg/".$_FILES["productimage"]["name"]);
$sql="INSERT INTO tblhotel(HotelName,HotelType,HotelLocation,HotelPrice,HotelFeatures,HotelDeatils,HotelImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)";
                                    ...
                                    <div class="card-body">
                                        <form name="package" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 col-lg-10">
                                                <select class="form-control" id="input-select" name="prodtype">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-lg-2 col-form-label text-right">Hotel Features:</label>
                                                <div class="col-9 col-lg-10">
                                                    <input id="" name="prodfeatures" type="text" required=""placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-3 col-lg-2 col-form-label text-right">Hotel Details:</label>
                                                    <div class="col-9 col-lg-10">
                                            ...
                                            <div class="form-group row justify-content-center">
                                                <div>
                                                    <button style="width: 150px;" type="submit" name="submit" class="btn-primary btn">Add Hotel</button>
                                                    &nbsp;&nbsp;&nbsp;
