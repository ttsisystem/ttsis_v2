        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Manage Hotel</h5>
                            <div class="card-body">
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="up_hotel.php?hid=<?php echo htmlentities($result->hotelid);?>">
                            <button type="button" class="btn btn-sm btn-primary" style="width: 70px;">Details
                            </button>

                          </a>
                                                        <a class="btn btn-sm btn-danger" name="btn_delete" data-toggle="" data-target="#" href="managehotel.php?id=<?php echo htmlentities($result->hotelid);?>">Delete</a>
                        </td>
                      </tr>
                      <?php $cnt=$cnt+1;} }?>
                                      </tbody>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Manage Hotel Rooms</h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="booktable" class="table table-striped table-bordered first">
                                      <thead>
                      ...
                      <tr>
                        ...
                        <td><?php echo htmlentities($result->Creationdate);?></td>
                        <td>
                          <a href="uphotel_room.php?hid=<?php echo htmlentities($result->HotelId);?>">
                            <button type="button" class="btn btn-sm btn-primary" style="width: 70px;">Details
                            </button>

                          </a>
                                                        <a class="btn btn-sm btn-danger" name="btn_delete" data-toggle="" data-target="#" href="managehotel.php?roomid=<?php echo htmlentities($result->HotelId);?>">Delete</a>
                        </td>
                      </tr>
                      <?php $cnt=$cnt+1;} }?>
                                      </tbody>
