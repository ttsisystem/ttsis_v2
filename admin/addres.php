...
$map=$_POST['map'];  
$pimage=$_FILES["resimage"]["name"];
move_uploaded_file($_FILES["resimage"]["tmp_name"],"res_img/".$_FILES["resimage"]["name"]);
$sql="INSERT INTO res(resname,reslocation,description,resimage,map) VALUES(:pname,:plocation,:details,:pimage,:map)";
                                        ...
                                        <form name="package" method="post" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 col-lg-10">
                                                    <input id="" name="resname" type="text" required=""placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-lg-2 col-form-label text-right">Restaurant Image</label>
                                                <div class="col-9 col-lg-10">
                                                <input type="file" name="resimage" id="packageimage" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
