...
move_uploaded_file($_FILES["himage"]["tmp_name"],"hotelsimg/".$_FILES["himage"]["name"]);
$sql="update tblhotel set HotelImage=:pimage where HotelId=:imgid";
$query = $dbh->prepare($sql);

$query->bindParam(':imgid',$imgid,PDO::PARAM_STR);
$query->bindParam(':pimage',$pimage,PDO::PARAM_STR);
$query->execute();
$msg=" Hotel Image Update Successfully";
}
?>
<!doctype html>
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="card bg-light">
                                    ...
                                    <?php 
									$imgid=intval($_GET['imgid']);
									$sql = "SELECT HotelImage from tblhotel where HotelId=:imgid";
									$query = $dbh -> prepare($sql);
									$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
									$query->execute();
