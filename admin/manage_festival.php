...
move_uploaded_file($_FILES["festivalfile"]["tmp_name"],"festivalfiles/".$_FILES["festivalfile"]["name"]);
$sql="INSERT INTO tblfestival (type,file) VALUES(:filetype,:festivalfile)";
...
$sql = "DELETE FROM tblfestival WHERE id=:id";
...
?>
            <div class="dashboard-wrapper">
                <div class="dashboard-ecommerce">
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Add Festival Image/Video</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="card bg-light">
                                    <h5 class="card-header">Add Festival Image/Video</h5>
                                    ...
                                    <div class="card-body">
                                        <form name="package" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-3 col-lg-2 col-form-label text-right">Festival Image/Video</label>
                                                <div class="col-9 col-lg-10">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Manage Festival Files</h5>
                            <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
                else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="booktable" class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * from tblfestival ORDER BY id DESC";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card text-center">
                                                                <div class="card-body"> <img style="width: 250px;" src="img/warning.png">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-6 mb-2 mb-md-0"> <a href="addimg.php?id=<?php echo htmlentities($result->id);?>" style="width: 150px;" name="btn_delete" class="btn btn-out btn-danger btn-square btn-large"> <i class="fa fa-trash"></i> Delete Data</a> </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <a class="btn btn-sm btn-danger" name="btn_delete" data-toggle="" data-target="#" href="manage_festival.php?id=<?php echo htmlentities($result->id);?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $cnt=$cnt+1;} }?>
                                        </tbody>
