...
move_uploaded_file($_FILES["packageimage"]["tmp_name"],"destination_img/".$_FILES["packageimage"]["name"]);
$sql="INSERT INTO TblTourPackages(PackageName,PackageType,PackageLocation,PackageFetures,PackageDetails,PackageImage) VALUES(:pname,:ptype,:plocation,:pfeatures,:pdetails,:pimage)";
                                        ...
                                        <form name="package" method="post" enctype="multipart/form-data">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 col-lg-10">
                                                    <input id="" name="desname" type="text" required=""placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-3 col-lg-2 col-form-label text-right">Bed Type:</label>
                                                <div class="col-9 col-lg-10">
                                                <select class="form-control" id="input-select" name="destype">
                                                    <option disabled value="">--Select Destination Type--</option>
                                                    <option value="Resort">Resort</option>
                                                    <option value="Eco Site">Eco Site</option>
                                                </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 col-lg-10">
                                                    <input id="" name="features" type="text" required=""placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-3 col-lg-2 col-form-label text-right">Destination Details:</label>
                                                    <div class="col-9 col-lg-10">
                                                        <textarea class="form-control" rows="5" cols="50" name="details" id="details" placeholder="Destination Details" required></textarea> 
                                                    </div>
                                            </div>
                                            <div class="form-group row">
