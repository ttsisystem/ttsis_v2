...
<?php } else {?>
<td>
    <a href="booking.php?bkid=<?php echo htmlentities($result->BookingId);?>" onclick="return confirm('Do you really want to cancel booking')" >
        Cancel
    </a> / 
    <a href="booking.php?bckid=<?php echo htmlentities($result->BookingId);?>" onclick="return confirm('Do you really want to cancel booking')" >
    Confirm
    </a>
</td>
</tr>
