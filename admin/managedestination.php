                                    ...
                                    <table id="booktable" class="table table-striped table-bordered first">
                                    	...
                                    	<tbody>
											...
											<tr>
												...
												<td>
													<a href="up_destination.php?pid=<?php echo htmlentities($result->PackageId);?>">
														<button type="button" class="btn btn-sm btn-primary" style="width: 70px;">Details
														</button>

													</a>
                                                        <a class="btn btn-sm btn-danger" name="btn_delete" data-toggle="" data-target="#" href="managedestination.php?id=<?php echo htmlentities($result->PackageId);?>">Delete</a>
												</td>
											</tr>
											<?php $cnt=$cnt+1;} }?>
                                    	</tbody>
